      ...
      <div className="h-[100vh] p-2">
        <div className="bg-white h-full flex justify-between border-4">
          <div className="w-[35%] border-r-2">
            <div className="bg-purple-800 h-[20%] p-16 text-2xl text-white font-semibold rounded-br-full">
              Nav bar
            </div>
            <div className="all_profiles h-[80%] p-6 bg-white overflow-y-auto">
          ...
          <div className="w-[65%] flex flex-col justify-between">
            <div className="top-chat-nav border-b-2 flex items-center px-5 ">
            ...
            <div className="chats h-[85%] bg-black">ALL PAYMENTS</div>
            <div className="pay_recive h-10 flex">
              <input
                type="number"
                className="mx-4 px-4 w-[60%] rounded-xl border border-1"
                placeholder="Enter Amount..."
              ></input>
              <div className="bg-green-400 px-10 rounded-lg text-white text-lg flex items-center mx-4">
                Paid
              </div>
